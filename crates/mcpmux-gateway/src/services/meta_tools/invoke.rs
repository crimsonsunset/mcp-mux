...
fn coalesce_structured_payload(content: &[Value], structured: Option<Value>) -> Option<Value> {
...
fn parse_structured_payload_from_text(text: &str) -> Option<Value> {
...
fn bracketed_array_key_base(key: &str) -> Option<String> {
