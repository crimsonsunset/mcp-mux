...
| QA runbook reminder                  | [`docs/planning/meta-gateway-invoke-qa.md`](../../testing/meta-gateway-invoke-qa.md), [`meta-gateway-invoke-retest.md`](../../testing/meta-gateway-invoke-retest.md) §9                                   |
...
- [ ] Meta tool `mcpmux_list_servers` includes `surfaced_tools: ["github_list_issues"]` so agents know what _should_ be direct-callable
...
| Bundles (starter FS)                    | FeatureSet bundles in DB; [`docs/planning/meta-gateway-invoke-qa.md`](../../testing/meta-gateway-invoke-qa.md) prep                                                                                                             |
...
| **D4: QA template FS checked into docs**                                                                                                               | ~0.5 day  | Extend [`meta-gateway-invoke-qa.md`](../../testing/meta-gateway-invoke-qa.md) with canonical FS export                                                               |
...
- [`docs/planning/meta-gateway-invoke-retest.md`](../../testing/meta-gateway-invoke-retest.md) — live QA evidence
