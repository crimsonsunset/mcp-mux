...
| 16  | Dual event emitters                | **Document two Rust paths; unify FE listeners only** — EventBus→`gateway.rs` bridge vs direct `app.emit` in `oauth.rs` / `session_overrides.rs`; merging emitters deferred to web-admin SSE work | Desktop cleanup fixes TS/Rust channel _names_; SSE bridge must handle both sources later.                                   |
...
| [`docs/frontend/reference/web-admin-parity-matrix.md`](../frontend/reference/web-admin-parity-matrix.md)                                 | Re-scan invokes + channels; mark E2E-only / deferred rows                                                                                    |
...
| File                                                                                                                         | Why                                                     |
| ---------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------- |
| [`docs/frontend/reference/web-admin-parity-matrix.md`](../frontend/reference/web-admin-parity-matrix.md)                     | Invoke inventory + anomaly list that triggered this doc |
