...
| `get_bundle_version` | `lib/api/app.ts` | `app` | GET | `GET /api/v1/app` → `get_bundle_version` | `command_bridge::app::get_bundle_version` | R | REST (web variant) | P4 | [ ] | [ ] | [ ] | [ ] |
...
| `get_gateway_port_settings` | `lib/api/settings.ts` | `gateway` | GET | `GET /api/v1/gateway` → `get_gateway_port_settings` | `command_bridge::gateway::get_gateway_port_settings` | R | REST | P4 | [ ] | [ ] | [ ] | [ ] |
...
| `get_logs_path` | `lib/api/settings.ts` | `app` | GET | `GET /api/v1/app` → `get_logs_path` | `command_bridge::app::get_logs_path` | R | REST (web variant) | P4 | [ ] | [ ] | [ ] | [ ] |
...
| `get_oauth_client_grants` | `lib/api/oauth.ts` | `oauth` | GET | `GET /api/v1/oauth` → `get_oauth_client_grants` | `command_bridge::oauth::get_oauth_client_grants` | R | REST | P4 | [ ] | [ ] | [ ] | [ ] |
| `get_oauth_clients` | `lib/api/oauth.ts` | `oauth` | GET | `GET /api/v1/oauth` → `get_oauth_clients` | `command_bridge::oauth::get_oauth_clients` | R | REST | P4 | [ ] | [ ] | [ ] | [ ] |
...
| `get_space` | `lib/api/spaces.ts` | `space` | GET | `GET /api/v1/spaces` → `get_space` | `command_bridge::space::get_space` | R | REST | P4 | [x] | [ ] | [ ] | [ ] |
| `get_startup_settings` | `lib/api/settings.ts` | `settings` | GET | `GET /api/v1/settings` → `get_startup_settings` | `command_bridge::settings::get_startup_settings` | R | REST | P4 | [ ] | [ ] | [ ] | [ ] |
| `get_version` | `lib/api/app.ts` | `app` | GET | `GET /api/v1/app` → `get_version` | `command_bridge::app::get_version` | R | REST (web variant) | P4 | [ ] | [ ] | [ ] | [ ] |
...
| `list_spaces` | `lib/api/spaces.ts` | `space` | GET | `GET /api/v1/spaces` → `list_spaces` | `command_bridge::space::list_spaces` | R | REST | P4 | [x] | [ ] | [ ] | [ ] |
...
| `read_space_config` | `lib/api/spaces.ts` | `space` | GET | `GET /api/v1/spaces` → `read_space_config` | `command_bridge::space::read_space_config` | R | REST | P4 | [x] | [ ] | [ ] | [ ] |
...
| `reset_gateway_port` | `lib/api/settings.ts` | `gateway` | GET | `GET /api/v1/gateway` → `reset_gateway_port` | `command_bridge::gateway::reset_gateway_port` | R | REST | P4 | [ ] | [ ] | [ ] | [ ] |
