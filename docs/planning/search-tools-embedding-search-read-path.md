...
**Blocks:** Consent QA [`consent-model-qa-runbook.md`](./consent-model-qa-runbook.md) Sections O1–O4 (blocked on O0b read-path pass)
...
| [`docs/planning/consent-model-qa-runbook.md`](./consent-model-qa-runbook.md) | O0b pass criteria update + unblock O1–O4 when read path fixed |
...
| [`docs/planning/consent-model-qa-runbook.md`](./consent-model-qa-runbook.md) | O0 Run 1 + O0b findings |
...
- [`consent-model-qa-runbook.md`](./consent-model-qa-runbook.md) — Section O0b gates O1–O4
...
*To be filled when this doc ships — planned vs shipped, validation results, link to commit(s).*
