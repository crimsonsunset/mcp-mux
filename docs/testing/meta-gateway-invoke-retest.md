...
**Related:** [`meta-gateway-invoke-qa.md`](./meta-gateway-invoke-qa.md) (full runbook), [`meta-gateway-invoke.md`](../backend/reference/meta-gateway-invoke.md) (spec)
...
1. List every tool you can call — separate mcpmux\_\* meta tools vs surfaced backend tools
